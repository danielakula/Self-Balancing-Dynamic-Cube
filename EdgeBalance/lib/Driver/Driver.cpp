...
void Driver::begin(SPIClass* spiBus) {
    ...
    if (_pins.soc != -1) analogRead(_pins.soc); 
    delay(10); 
    ...
    _motor.phase_inductance = _config.L;
    _motor.KV_rating = 195.0f;
    ...
    _motor.PID_current_q.P = calc_P;
    _motor.PID_current_q.I = calc_I;
    _motor.PID_current_d.P = calc_P;
    _motor.PID_current_d.I = calc_I;
    _motor.LPF_current_q.Tf = calc_Tf; 
    _motor.LPF_current_d.Tf = calc_Tf;

    _motor.current_limit = _config.current_limit;
    _motor.voltage_sensor_align = 1.0f;
    _motor.velocity_limit = 10.0f; 

    _motor.PID_current_d.output_ramp = 10000.0f;
    _motor.PID_current_q.output_ramp = 10000.0f;
    _motor.PID_current_d.D           = 0.0f;
    _motor.PID_current_q.D           = 0.0f;
    _motor.PID_current_d.limit       = 15.0f;
    _motor.PID_current_q.limit       = 15.0f;
