...
fig = figure('Name', 'Robot Balancing Dynamics', 'Units', 'centimeters', 'Position', [5, 5, 16, 12], 'Color', 'w'); 
...
% ---------------------------------------------------------
ax1 = nexttile;
plot(out.Position.Time, out.Position.Data, 'LineWidth', 1.5, 'Color', c3);
grid on; box on;
title('A: Cube Orientation $\theta_b$', 'FontSize', 14);
ylabel('Position (rad)', 'FontSize', 13);
...
% ---------------------------------------------------------
ax2 = nexttile;
plot(out.Wheel_Velocity.Time, out.Wheel_Velocity.Data, 'LineWidth', 1.5, 'Color', c3);
grid on; box on;
title('B: Wheel Velocity $\dot \theta_w$', 'FontSize', 14);
ylabel('Velocity (rad/s)', 'FontSize', 13);

% ---------------------------------------------------------
% Tile 3: Cube Velocity (Bottom Left)
% ---------------------------------------------------------
ax3 = nexttile;
plot(out.Cube_Velocity.Time, out.Cube_Velocity.Data, 'LineWidth', 1.5, 'Color', c3);
grid on; box on;
title('C: Cube Velocity $\dot \theta_b$', 'FontSize', 14);
ylabel('Velocity (rad/s)', 'FontSize', 13);
...
% ---------------------------------------------------------
ax4 = nexttile;
plot(out.Torque.Time, out.Torque.Data, 'LineWidth', 1.5, 'Color', c3);
grid on; box on;
title('D: Control Torque $u$', 'FontSize', 14);
ylabel('Torque (N$\cdot$m)', 'FontSize', 13);
